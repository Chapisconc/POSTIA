  ...
  return (
    ...
    >
      <div className="flex-1">
        <label className="mb-1 block text-sm text-slate-300" htmlFor="customer-name">
          Nombre
        </label>
        <input
          id="customer-name"
      ...
      <div className="w-56">
        <label className="mb-1 block text-sm text-slate-300" htmlFor="customer-email">
          Correo
        </label>
        <input
          id="customer-email"
      ...
      <div className="w-44">
        <label className="mb-1 block text-sm text-slate-300" htmlFor="customer-phone">
          Teléfono
        </label>
        <input
          id="customer-phone"
